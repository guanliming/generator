 ...
 * 2019-07-28
 */
public class AdminController extends AbstractContainer {
    private static String curDir = baseDir + File.separator + projectName + File.separator + projectName + "-admin";
    private static String curModuleName = projectName + "-admin-controller";
    ...
    public void createPom() throws Exception {
        FreemarkerUtil.generate("adminController.ftl",
